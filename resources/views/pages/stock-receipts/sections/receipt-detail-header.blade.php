<section class="card receipt-detail-header">
    ...
    <dl class="receipt-detail-grid">
        <div><dt>Tanggal penerimaan</dt><dd>{{ $stockReceipt->receipt_date->locale('id')->translatedFormat('d F Y') }}</dd></div>
        ...
        <div><dt>Waktu input</dt><dd>{{ $stockReceipt->created_at->locale('id')->translatedFormat('d F Y · H.i') }}</dd></div>
