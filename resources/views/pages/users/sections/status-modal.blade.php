<div class="modal" id="user-status-modal" data-modal data-close-on-overlay="true" role="dialog" aria-modal="true" aria-labelledby="user-status-title" hidden>
    <div class="modal__overlay" data-modal-overlay></div>
    <div class="modal__positioner">
        <div class="modal__dialog" data-modal-dialog tabindex="-1">
            <div class="modal__header">
                <div>
                    <p class="eyebrow">Status Pengguna</p>
                    <h2 id="user-status-title" data-status-title>Konfirmasi status</h2>
                </div>
                <button class="modal__close" type="button" data-modal-close aria-label="Tutup modal">×</button>
            </div>
            <div class="modal__body">
                <p data-status-message>Pastikan perubahan status pengguna sudah sesuai.</p>
            </div>
